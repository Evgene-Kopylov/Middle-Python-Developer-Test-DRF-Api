...
urlpatterns = [
    ...
    path('list_publishers/<int:page>/<int:size>/', views.list_publishers),
    path('list_authors/<int:page>/<int:size>/', views.list_authors),
    path('list_books/<int:page>/<int:size>/', views.list_books),
